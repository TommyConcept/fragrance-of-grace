...
const milestones = [
  {
    ...
    date: 'Before 2024',
    title: 'The Quiet Forming',
    description:
      'For many years, God was shaping a call in silence. Serving as a worship leader, writing songs inspired by deep faith, Hilda walked through seasons of preparation — carrying a vision that fear and feelings of inadequacy had not yet released.',
    accent: false,
  },
  {
    id: 2,
    ...
    date: '2024',
    title: 'Give Thanks — The First Album',
    description:
      'Answering the call she had carried for years, Hilda released her debut album Give Thanks — a worship offering rooted in gratitude and the goodness of God. A milestone of courage, obedience, and faith.',
    accent: true,
  },
  {
    id: 3,
    ...
    description:
      "Your Will Be Done — a song of surrender — was released in December 2025. Alongside it, God placed a new vision in Hilda's heart: the Fragrance Podcast, a space to speak on identity in Christ, purpose, and the revelation of His grace.",
    accent: false,
  },
];
