    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-16">
          ...
          {/* Podcast image */}
          {/* Image: public/images/hilda-4.jpg */}
          <div className="relative flex justify-center lg:justify-start">
            <div className="relative w-full max-w-sm">
              <img
                src="/images/hilda-4.jpg"
                alt="Hilda Akpala — host of the Fragrance Podcast"
                className="w-full h-auto rounded-2xl shadow-lg object-cover"
                loading="lazy"
              />
              <div
                className="absolute -bottom-5 -left-5 sm:-left-8 bg-white rounded-xl shadow-lg px-4 py-3 border border-gold/20 hidden sm:block"
                aria-hidden="true"
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-navy text-xs font-inter font-semibold leading-tight">Available on</p>
                    <p className="text-gold text-xs font-inter">YouTube & Spotify</p>
                  </div>
                </div>
              </div>
            </div>
