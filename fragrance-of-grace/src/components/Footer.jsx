...
export default function Footer() {
  return (
    <footer className="bg-navy border-t border-gold/10" aria-label="Site footer">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 mb-10">
          ...
          <div className="md:col-span-1">
            ...
            >
              ...
              <div>
                <span
                  className="text-ivory font-playfair text-base font-medium block leading-tight"
                  style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
                >
                  Fragrance of Grace
                </span>
                <span className="text-ivory/40 text-xs font-inter tracking-widest uppercase">
                  Identity in Christ
                </span>
              </div>
            </a>
            <p className="text-ivory/55 font-inter text-sm leading-relaxed max-w-xs">
                ...
                {navLinks.map((link) => (
                  <li key={link.href}>
                    <a
                      ...
                      className="text-ivory/60 font-inter text-sm hover:text-gold transition-colors"
                    >
                      {link.label}
                    </a>
                  </li>
          ...
          <div>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-ivory/60 hover:text-gold hover:border-gold/40 transition-all"
                    role="listitem"
            ...
            <div className="space-y-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-ivory/55 font-inter text-xs hover:text-gold transition-colors"
              >
        ...
        {/* Bottom bar */}
        <div className="border-t border-white/10 pt-7 flex flex-col sm:flex-row items-center justify-between gap-3 text-center">
          <p className="text-ivory/35 font-inter text-xs">
            &copy; 2026 Fragrance of Grace. All rights reserved.
          </p>
          <p className="text-ivory/20 font-inter text-xs">
            Designed with grace.
          </p>
        </div>
