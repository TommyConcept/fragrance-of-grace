...
export default function Header() {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="xl:hidden p-2 text-navy hover:text-gold transition-colors"
      ...
      {/* Mobile Menu */}
      <div
        className={`xl:hidden bg-white border-t border-gold/10 transition-all duration-300 overflow-hidden ${
