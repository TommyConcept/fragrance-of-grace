...
export default function About() {
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-navy font-inter text-base sm:text-lg leading-relaxed">
              I am Hilda Akpala, a Christian recording artist, worshipper, educator, and the host
              of the Fragrance Podcast. I hold a Master of Arts in Teaching (MAT) in Special
              Education from Towson University, Maryland. My life and calling are centered on one
              message—expressing the identity of Christ through songs, worship, and the
              revelation of His grace.
            </p>
            <p className="text-navy font-inter text-base sm:text-lg leading-relaxed">
              Fragrance is more than a concept to me—it is a spiritual expression. As fragrance
              fills a room without being seen, I believe the lives of believers carry the
              presence of God wherever they go. Through music, teaching, and lessons of life, I
              share messages that point people back to their identity in Christ.
            </p>
            <p className="text-navy font-inter text-base sm:text-lg leading-relaxed">
              This platform brings together everything I do: the podcast, the music, and daily
              reels that encourage believers to walk boldly in grace.
            </p>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-10 md:mt-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-sage rounded-2xl p-8 md:p-12">
          <div>
            <p className="text-navy/70 text-xs font-inter tracking-[0.25em] uppercase mb-3 font-medium">
              My Mission
            </p>
            <p className="text-navy font-inter text-base sm:text-lg leading-relaxed font-medium">
