      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
          ...
          <div className="relative flex justify-center">
            {/* Primary image */}
            {/* Image: public/images/hilda-1.jpg */}
            <div className="relative z-10 w-64 sm:w-72 md:w-80">
              <img
                src="/images/hilda-1.jpg"
            ...
            {/* Image: public/images/hilda-2.jpg */}
            <div className="absolute top-8 -left-4 sm:left-0 w-32 sm:w-40 rounded-xl overflow-hidden shadow-lg border-4 border-white z-20 hidden md:block">
              <img
                src="/images/hilda-2.jpg"
                alt="Hilda Akpala in ministry"
          ...
          <div className="flex flex-col gap-5">
            <p className="text-navy font-inter text-base sm:text-lg leading-relaxed">
              I am <strong className="font-semibold">Hilda Akpala</strong>, a Christian recording
              artist, a worshipper, and the host of the Fragrance Podcast. My life and calling are
              centered on one message: expressing the identity of Christ through sound, worship, and
              the revelation of His grace.
            </p>
            <p className="text-muted font-inter text-base leading-relaxed">
              Fragrance is more than a concept to me — it is a spiritual expression. Just as
              fragrance fills a room without being seen, I believe the life of a believer carries
              the presence of God wherever they go. Through music, teaching, and storytelling, I
              share messages that point people back to their identity in Christ.
            </p>
            <p className="text-muted font-inter text-base leading-relaxed">
              This platform brings together everything I do — the podcast, the music, and the
              messages that encourage believers to walk boldly in grace.
            </p>
