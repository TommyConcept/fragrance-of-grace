...
export default function Connect() {
  return (
    <section
      ...
      style={{ background: 'linear-gradient(160deg, #FAF6EE 0%, #F0EAD8 50%, #E8E0C8 100%)' }}
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-muted font-inter text-base sm:text-lg leading-relaxed max-w-2xl mx-auto mb-12">
          ...
          {socialLinks.map((social) => {
            ...
            return (
              <a
                ...
                className={`flex items-center gap-2.5 px-6 py-3 rounded-full border border-navy/15 text-navy bg-white font-inter text-sm font-medium transition-all duration-200 ${social.color}`}
                role="listitem"
        ...
        {/* Email Signup */}
        <div
          className="rounded-2xl px-6 sm:px-10 py-10 border border-gold/20 bg-white"
        >
          <h3
            className="font-playfair text-navy text-2xl sm:text-3xl font-semibold mb-2"
            style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
          >
            Receive prayers + messages in your inbox
          </h3>
          <p className="text-muted font-inter text-sm mb-7 leading-relaxed">
