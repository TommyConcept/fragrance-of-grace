...
export default function Shop() {
  return (
    <section
      id="shop"
      className="pt-24 md:pt-28 lg:pt-32 pb-14 md:pb-20 lg:pb-24 bg-sage"
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* Email Signup */}
        <div className="rounded-2xl px-6 sm:px-10 py-10 border border-navy/10 bg-white/60 max-w-xl mx-auto">
          <h3
          ...
          <p className="text-navy/70 font-inter text-sm mb-7 leading-relaxed">
            Drop your email below and be the first to know the moment the eBook and Merch go
            live, Beloved.
          </p>
