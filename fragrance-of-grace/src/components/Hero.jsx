...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* Overlay — light wash so the image stays visible, darker toward the bottom for text contrast */}
      <div
        className="absolute inset-0"
        style={{
          background: 'linear-gradient(180deg, rgba(11,27,51,0.35) 0%, rgba(11,27,51,0.40) 35%, rgba(11,27,51,0.55) 70%, rgba(11,27,51,0.65) 100%)',
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto px-4 sm:px-6 py-24 pt-36 text-center flex flex-col items-center">
        ...
        {/* Eyebrow */}
        <p className="text-gold text-xs sm:text-sm font-inter font-medium tracking-[0.25em] uppercase mb-6 opacity-95" style={{ textShadow: '0 2px 8px rgba(11,27,51,0.6)' }}>
          Welcome, Beloved
        </p>
        ...
        <h1
          ...
          style={{ fontFamily: "'Playfair Display', Georgia, serif", textShadow: '0 4px 20px rgba(11,27,51,0.7)' }}
        >
          Fragrance of Grace
        </h1>
        ...
        {/* Supporting Heading */}
        <h2
          className="text-ivory/95 font-playfair text-lg sm:text-xl md:text-2xl font-normal italic leading-relaxed mb-6 max-w-2xl"
          style={{ fontFamily: "'Playfair Display', Georgia, serif", textShadow: '0 2px 12px rgba(11,27,51,0.7)' }}
        >
        ...
        {/* Supporting Text */}
        <p className="text-ivory/95 font-inter text-sm sm:text-base leading-relaxed max-w-xl mb-10" style={{ textShadow: '0 2px 10px rgba(11,27,51,0.65)' }}>
        ...
        <div className="mt-12 flex flex-col items-center gap-2 opacity-50" aria-hidden="true">
          ...
          <span className="text-ivory text-xs font-inter tracking-widest uppercase" style={{ textShadow: '0 2px 8px rgba(11,27,51,0.6)' }}>Scroll</span>
        </div>
      </div>
    </section>
  );
